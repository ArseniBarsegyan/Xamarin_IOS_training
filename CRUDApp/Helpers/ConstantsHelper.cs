namespace CRUDApp.Helpers
{
    public static class ConstantsHelper
    {
        ...
        public const string NoUserOrPasswordIncorret = "No such user or password incorrect";
        public const string Ok = "Ok";
        public const string PasswordError = "Password error";
        public const string PasswordsDoesNotMatch = "Passwords doesn't match";
        ...
        public const string UsePinKey = "UsePinKey";
